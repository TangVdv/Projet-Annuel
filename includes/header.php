        ...
        <ul class="nav">
          ...
          if (isset($_SESSION['email'])) {
              echo "<li class='nav-item'><a href='/signIn-Up/logOut.php' class='nav-link text-white px-2' translate-key='logout-title'></a> </li>";
      				echo "<li class='nav-item'><a href='#' class='nav-link text-white px-2' translate-key='account-title'></a> </li>";
              echo "<li class='nav-item'><a href='/panier/' class='nav-link text-white px-2' translate-key='basket-title'></a> </li>";
      			}
      		else{
